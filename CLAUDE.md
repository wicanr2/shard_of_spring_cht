...
> **A、B、C、E、F、G、H、I、K、L 已 RE-DONE**(J 曾在 `97` 宣告,`102` 撤回)(`docs/re/67` §3、`68` §3、`66` §4、`54` §4、`60` §5、`49` §4、`61` §4、`62` §5、`71` §5、`91` §3、`97` §4 逐條核對)。
...
| D. 角色／隊伍資料與存檔 | `CHARS.DAT` / `GROUPS.DAT` 的欄位與存檔流程 | 進行中(`100`:`CHARS.DAT` 整數欄 **14/15** 有語意。**缺:位移 84、`GROUPS.DAT` 11 欄 —— 該檔出貨全空白,只能從程式碼追**)|
...
| J. 戰鬥規則 | 命中／傷害／先攻／逃跑的判定 | 進行中(`76` 命中、`79` 傷害、`83` 死亡、`93` 先攻、`96` 朝向;`97` 的 RE-DONE 已被 `102` 撤回。**缺:逃跑的判定條件**)|
