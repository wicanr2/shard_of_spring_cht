...
> **A、B、C、E、F、G、H、I、J、K、L 已 RE-DONE**(`docs/re/67` §3、`68` §3、`66` §4、`54` §4、`60` §5、`49` §4、`61` §4、`62` §5、`71` §5、`91` §3、`97` §4 逐條核對)。
...
| D. 角色／隊伍資料與存檔 | `CHARS.DAT` / `GROUPS.DAT` 的欄位與存檔流程 | 進行中(記錄長度 94/90、讀寫端、**奇偶性分開兩個檔**、`CHARS.DAT` 整數欄 11/15 有語意。**缺:12/20/22/84 與 `GROUPS.DAT` 多數欄位**)|
...
| J. 戰鬥規則 | 命中／傷害／先攻／逃跑的判定 | **RE-DONE**(`97` §4 逐條核對;逃跑=不存在,證據充分)|
