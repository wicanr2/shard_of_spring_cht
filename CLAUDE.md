...
> **H、F、G、I、L 已 RE-DONE**(`docs/re/49` §4、`54` §4、`60` §5、`61` §4、`62` §5 逐條核對)。
...
| C. 原生輔助程式庫 | **`USERLIB.EXE`**(另三支已改歸 A)| 進行中(`30`/`63`/`64`:11/11 模組載入、字串表 60 段、**呼叫機制 = `3D:00` 延遲繫結,匯出表在模組 `ds:0x0A1E`,19 個槽 8-byte 對齊**。**只缺:每個槽做什麼**)|
