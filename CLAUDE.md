...
> **A、B、C、F、G、H、I、L 已 RE-DONE**(`docs/re/67` §3、`68` §3、`66` §4、`54` §4、`60` §5、`49` §4、`61` §4、`62` §5 逐條核對)。
...
| K. 輸入語意（**不含 BIOS 層**） | 哪些鍵在哪個畫面有效、對應什麼動作 | 進行中(`28`/`58`/`69`/`70`:小鍵盤轉譯層 + 七支模組比對鏈全數抽出、`1北2東` 從程式碼確認、`C`=Camp 確認;**缺:`P`/`Q`/`J` 動作、`S`=Save 升確認、`N`/`K`/`R` 三個提示字母**)|
