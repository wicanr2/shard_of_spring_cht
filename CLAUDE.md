...
> **H、F、G 已 RE-DONE**（`docs/re/49`/`54`/`57` 各 §4–5 逐條核對）；其餘各列未達門檻。
...
| G. 地城與迷宮 | `DG*MAZE.SQZ`、`MAZEDATA.BIN`、`DT*TEXT.DAT`、`MAZEITEM.PIC` | ✅ **RE-DONE**(`50`/`51`/`55`/`56`/`57`:81×51 跑長規則取自程式碼、`MAZEDATA` 八欄全解、`DT*TEXT` 87 筆、`MAZEITEM` 行 k = 圖塊 k。四項條件核對見 `57` §5)|
