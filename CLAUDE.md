...
> **A、B、C、E、F、G、H、I、J、K、L 已 RE-DONE**(J 曾在 `97` 宣告、`102` 撤回、`103` 重新收斂)(`docs/re/67` §3、`68` §3、`66` §4、`54` §4、`60` §5、`49` §4、`61` §4、`62` §5、`71` §5、`91` §3、`97` §4 逐條核對)。
...
| D. 角色／隊伍資料與存檔 | `CHARS.DAT` / `GROUPS.DAT` 的欄位與存檔流程 | 進行中(`CHARS.DAT` 整數欄 14/15 + 字元欄全部;**`GROUPS.DAT` 11/14**(`109`:時/日/月/能見度從 `ds:3010h` 的位移參數定案)。**缺:位移 84、25、61、三個待重驗**)|
