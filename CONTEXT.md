...
| 項目 | 卡在哪 |
|---|---|
| **引擎 M0–M7 全部完成** | 世界地圖、角色與存檔、戰鬥、迷宮與事件、法術與道具、中文化上線。⚠ 各里程碑的未解項見 `docs/spec/03-engine-plan.md` 的狀態欄 |
...
| **模組內 1,012 段字串的中文化** | 需要先把 1,085 個引用點歸戶到畫面(`docs/re/124`);而 remake 也還沒有商店/營地/角色創造那些畫面 |
