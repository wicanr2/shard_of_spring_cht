...
| 測試 | **14,267 行 / 504 條** | 兩套字型後端各跑一次(預設 TTF 與 `-tags eten`)|
...
| **引擎** | ✅ 世界地圖、地城、戰鬥、戰場、法術、道具、城鎮、商店、營地、名冊、創角、訓練、治療、經驗、技能點、音樂、音效都實作了。原版忠實與手繪冒險書主題可用 `F6` 獨立切換；共 **19,927 行 Go + 14,267 行測試（504 條）**。⚠ 兩條規則明確地**沒有**實作(見下面「與原版的差異」),而且標在遊戲畫面上 |
