...
—— 標題、主選單、世界地圖、城鎮、地城、最終戰,29 秒,配的是本專案自己寫的場景配樂。
...
| **還開著的** | 只有一項場景架構重構(C2),而它的[重啟判準量過了、未達成](docs/spec/14-remake-worklist.md) —— 現在不該做 |
...
|---|---|---|
| **遊戲規則** | — | **一致** —— 命中、傷害、經驗曲線、升級成長、法術效力、遭遇、可通行性、事件都照反組譯結果實作 |
