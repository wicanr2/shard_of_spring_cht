...
**位移 52–53 與 86–94 沒有語意**,而**經驗值找不到落點**
([`re/140`](../re/140-manual-stat-tables.md) §9):出貨五人的 86–88 仍是 `0x20`
(從未被寫過),[`re/89`](../re/89-record-offset-census.md) 的位移聯集也沒有一個落在那裡,
而經驗值最大 12,752,200 放不進 2-byte 整數。
