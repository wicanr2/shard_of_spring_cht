...
而 [`60`](60-event-lookup-and-tile-19.md) 已知地形值 12/13/20–32 是分類過的地圖圖塊,
`0x10D5A` 起正是在比這些值。
...
| `CHARS.DAT` 位移 1 的 `'5'` | **已解**:所屬隊伍編號,出貨的五人是手冊寫的 PARTY #5([`133`](133-chars-offset-1-is-party.md))|
...
| | 子系統 | 收斂於 |
|---|---|---|
| A | 執行檔架構與模組轉交 | [`67`](67-a-closure-module-handoff.md) |
...
| G | 地城與迷宮 | [`60`](60-event-lookup-and-tile-19.md) |
| H | 圖形格式 | [`49`](49-h-closure.md) |
| I | 法術效果表 | [`61`](61-i-closure-unused-tiles.md) |
| J | 戰鬥規則 | [`103`](103-flee-is-leaving-the-field.md)(`97` 曾宣告、`102` 撤回)|
| K | 輸入語意 | [`71`](71-k-closure.md) |
| L | 中文化落點盤點 | [`62`](62-l-localization-inventory.md) + [`63`](63-userlib-strings-and-l-correction.md) |
