...
| `w8` | 1–13 | 11 | **序列內的序號,不是等級**([`31`](31-combat-fields.md) §3)|
| `w9` | 0–88 | 20 | **魔法相關**(31 隻施法者有值、43 隻物理型為 0,[`31`](31-combat-fields.md) §2)|
...
| 2 | **價格** | 0–8331 | **證據充分**([`33`](33-quiz-validates-columns.md) §2.1)|
| 3 | **型別相依的主數值**(武器=傷害、護甲=防護)| 0–99 | **證據充分**([`33`](33-quiz-validates-columns.md) §2.2)|
| 4 | 未解 | 0–26 | |
