...
| **M10** | 戰場:15×15、行動點數、離場 | ✅ **完成**:點數 = 速度、前進 2 / 轉向 1 / 攻擊 3、只打面前那一格、走上外圈離場;隊伍佈陣每列三個([`re/160`](../re/160-party-deploys-three-per-row.md));⚠ 怪物佈陣與 AI 仍是佔位([`12-combat-board.md`](12-combat-board.md))|
