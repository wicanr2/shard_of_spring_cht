...
| **M10** | 戰場:格陣列 31 寬、行動點數、離場 | ✅ **完成**:點數 = 速度、前進 2 / 轉向 1 / 攻擊 3、只打面前那一格、走上外圈離場;隊伍佈陣每列三個、基準 (13,13)([`re/160`](../re/160-party-deploys-three-per-row.md)、[`re/164`](../re/164-board-stride-31-and-base-13.md));戰場高度 = **31**([`re/218`](../re/218-four-named-assumptions-audited.md) §2);怪物 AI 的出場、鎖定、逐步選格都解了並接線,⚠ **施法只解規則沒接線**(投入與目標格未讀到,見 [`14`](14-remake-worklist.md) D3)|
